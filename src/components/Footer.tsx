...
export default async function Footer() {
  ...
  const footerName = genFirstNameAndSurnameInitial(firstName, surname)
      ...
      <div className="container py-10 flex flex-col gap-8">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-5">
            {socials.map(({ href, label, icon, stroke }) => (
              <a
                key={label}
                href={href}
        ...
        {/* Bottom row */}
        <div className="flex flex-col sm:flex-row justify-between items-center gap-2 pt-6 border-t border-faint">
          <p className="text-[0.7rem] text-muted">
            © {year} {firstName} {surname}. All rights reserved.
          </p>
          <p className="text-[0.7rem] text-muted">
