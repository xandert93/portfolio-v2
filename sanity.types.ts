...
// Query: *[_type == "project"] | order(date desc){    _id,    title,    'slug': slug.current,    summary,    techStack[]->{ _id, name },    repoUrl,    liveUrl,    coverImage,    isFeatured,    date  }
...
// Query: *[_type == "project" && isFeatured == true] | order(date desc){    _id,    title,    'slug': slug.current,    summary,    techStack[]->{ _id, name },    repoUrl,    liveUrl,    coverImage,    date  }
...
// Query: *[_type == "project" && slug.current == $slug][0]{    _id,    title,    'slug': slug.current,    summary,    description,    techStack[]->{ _id, name },    repoUrl,    liveUrl,    coverImage,    date  }
...
// Query: *[_type == "project" && isFeatured != true] | order(date desc) [$start...$end]{    _id,    title,    'slug': slug.current,    summary,    techStack[]->{ _id, name },    repoUrl,    liveUrl,    coverImage,    isFeatured,    date  }
...
// Query: *[_type == "post"] | order(publishedAt desc){    _id,    title,    'slug': slug.current,    excerpt,    coverImage,    tags[]->{ _id, name },    publishedAt,    updatedAt  }
...
// Source: src/sanity/lib/queries.ts
// Variable: POST_QUERY
// Query: *[_type == "post" && slug.current == $slug][0]{    _id,    title,    'slug': slug.current,    excerpt,    body,    coverImage,    tags[]->{ _id, name },    publishedAt,    updatedAt  }
